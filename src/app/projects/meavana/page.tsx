...
export default function MeavanaProject() {
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
            MeaVana: Elevating Productivity with a Chrome Extension
          </h1>

          <p className="text-xl text-teal-400 mb-8 font-medium">Product Manager/Developer | May 2025 - Aug 2025</p>
